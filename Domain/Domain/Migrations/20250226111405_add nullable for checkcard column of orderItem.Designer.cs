...
namespace BlindBoxSystem.Domain.Migrations
{
    ...
    [Migration("20250226111405_add nullable for checkcard column of orderItem")]
    partial class addnullableforcheckcardcolumnoforderItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RolledItem", b =>
                {
                    b.HasOne("Domain.Domain.Entities.BoxItem", null)
                        .WithMany()
                        .HasForeignKey("BoxItemsBoxItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Domain.Entities.OnlineSerieBox", null)
                        .WithMany()
